...
### ```id``` :
The id field is unique to each listing, but a listing is not necessarily unique to a room. There are many 'duplicate' listings, which are differentiated by other fields in the dataset. This is because listings may be deleted, reinstated, or edited. There may also be multiple listings for the same property.
...
__Interestingly only__ ***210 of 224*** __general wards are present in the sumary dataset.__
